...
class DuelingDeepQNetwork(nn.Module):
    def __init__(self, lr, input_dims, fc1_dims, fc2_dims, n_actions):  # 2 64 32
...
class Agent():
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions,
        ...
        self.Q_eval = DuelingDeepQNetwork(self.lr, n_actions=n_actions, input_dims=input_dims,
                                          fc1_dims=256, fc2_dims=64)
        # Fixed Deep Q Network
        self.Q_target = DuelingDeepQNetwork(self.lr, n_actions=n_actions, input_dims=input_dims,
                                            fc1_dims=256, fc2_dims=64)
